...
public class RutaInicial extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("direct:sendEmail")
                ...
                .to("smtp://smtp.gmail.com:465?username=distribucionespremiumcial@gmail.com&password=slkt%20iwgs%20iatt%20jucl&from=distribucionespremiumcial@gmail.com&to=distribucionespremiumcial@gmail.com&subject=Prueba1&mail.smtp.auth=true&mail.smtp.starttls.enable=true")
